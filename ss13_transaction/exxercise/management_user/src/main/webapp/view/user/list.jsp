...
<div class="d-flex justify-content-center html-editor-align-center">
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-danger">
                        <a href="${pageContext.request.contextPath}/user?action=edit&id=${user.getId()}" style="color: white; text-decoration: none">Edit</a>
                    </button>
                </td>
                <td>
        ...
        <div class="modal-content">
            ...
            <form action="/user?action=delete" method="post">
                <div class="modal-body">
                    ...
                    Bạn có muốn xóa người dùng <span id="deleteName" style="color: red; font-weight: bold"></span>
                    không ?
                </div>
