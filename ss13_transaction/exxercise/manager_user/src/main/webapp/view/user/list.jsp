...
<form class="d-flex" action="/user?action=search" method="post">
    <input class="form-control me-2" style="width: 300px" type="search" placeholder="Search" aria-label="Search" name="country"
           value="${user.country}">
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-danger">
                        <a href="${pageContext.request.contextPath}/user?action=edit&id=${user.getId()}">Edit</a>
                    </button>
                </td>
                <td>
